            ...
            <div class="m-portlet__head">
                ...
                <div class="m-portlet__head-wrapper">
                    <div class="m-portlet__head-caption">
                        <div class="m-portlet__head-title">
                            <h3 class="m-portlet__head-text">
                                {{ trans_choice($routePrefix.'new_update', 2) }}
                            </h3>
                        </div>
                    </div>
                    ...
                    <span>
                        ...
                        <button type="button" class="btn btn-primary m-btn m-btn--icon m-btn--wide m-btn--md edit-button">
                    <span>
                        <i class="la la-check"></i>
                        <span>{{ trans('models.common.update') }}</span>
                    </span>
                        </button>
                    </div>
                </div>
            ...
            <div class="m-portlet__body">
                @section('form')
                    {!! Form::model($model,['route' => array_merge([$routePrefix.'update'], $routeParameters ?? [], [$model->id]), 'files' => true, 'method' => 'PUT', 'id' => 'm_form', 'class' => 'm-form m-form--state m-form--fit m-form--label-align-right']) !!}
                        @include($routePrefix.'component.edit')
                    {!! Form::close() !!}
                @show
            </div>
        </div>
